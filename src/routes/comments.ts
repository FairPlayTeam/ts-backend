...
registerRoute({
  ...
  description:
    'Returns the direct replies of a comment. Use this endpoint recursively to implement infinite nested replies. Each reply includes likeCount, user (with proxied avatarUrl), and _count.replies to indicate if more nested replies are available.',
